...
class StudentForm extends FormBase {
  ...
  public function validateForm(array & $form, FormStateInterface $form_state) {
   ...
   $re_url = Url::fromRoute('dn_students.student');
    ...
    // style field first name with 1px solid red border when field is empty and show invalid message.
    ...
    $paginationData = $session->get('paginationNo');
	  ...
	  $render_array = \Drupal::formBuilder()->getForm('Drupal\dn_students\Form\StudentTableForm',$paginationData);
